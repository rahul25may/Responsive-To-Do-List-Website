...
function update() {
    ...
    itemJsonArray.forEach((element, index) => {
        str += `
<tr>
    <th scope="row" class="gap-col-1 tableH brb">${index + 1}</th>
    <td class="gap-col font-col brb">${element[0]}</td>
    <td class="gap-col font-col brb">${element[1]}</td>
    <td class="gap-col font-col brb cent"><button class="btn btn-sm btn-primary" onclick="deletedG(${index})">Delete</button></td>
    </tr>   
    `
    });
